...
void DirectoryManager::Init()
{
	...
	m_vecExtension.push_back(".fx");
	
	m_vecExtension.push_back(".jpg");
	m_vecExtension.push_back(".png");
	m_vecExtension.push_back(".dds");
	m_vecExtension.push_back(".fbx");


	m_vecExtension.push_back(".mp3");
	m_vecExtension.push_back(".wav");
	
	m_vecExtension.push_back(".dll");
	m_vecExtension.push_back(".lib");
	m_vecExtension.push_back(".bat");

	m_vecExtension.push_back(".sln");
	m_vecExtension.push_back(".vcxproj");
